...
function setupWorld() {
  ...
  * The position and angle of the camera on the sitting edge.
...
* Settings for models and material,Geometry to store all buildings of the city,
...
```
* Set the mesh of the city and create the lighting system and add to the scene
